...
values
  ...
  ('ai_redraw_model', '{"mode":"quality","preset":"quality","label":"Kualitas","provider":"litellm_image","primaryProvider":"litellm_image","fallbackProvider":"openrouter_image","liteLlmImageModel":"openai/gpt-image-1.5","analysisModel":"","generationModel":"black-forest-labs/flux.2-klein-4b","fallbackModel":"sourceful/riverflow-v2-fast","safetyModel":"nvidia/nemotron-3.5-content-safety:free","promptProfile":"photo_logo_cleanup","generationQuality":"high","imageSize":"1K","reasoningEffort":"medium","backgroundMode":"transparent","safetyEnabled":true,"aspectPolicy":"match_source","resolutionPolicy":"high","preprocess":"node_heuristic","persistPrompt":true,"retryOnLowConfidence":false,"estimatedUsdPerImage":0.05,"note":"Default LiteLLM GPT Image 1.5 photo logo cleanup dengan OpenRouter fallback otomatis."}'::jsonb, false, 'Pipeline LiteLLM primary + OpenRouter fallback untuk AI redraw')
on conflict (key) do update
set value = case
